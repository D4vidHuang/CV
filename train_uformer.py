...
def parse_args_and_config():
    ...
    parser.add_argument("--test_set", type=str, default='Uformer_sd',
                        help="restoration test set results: ['Raindrop_DiT', 'RDiffusion', 'IDT', 'restormer', 'Uformer', 'ICRA256', 'onego', 'atgan', 'Uformer_frequency', 'Uformer_sd']")
