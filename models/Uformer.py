...
class Uformer_frequency(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        conv3 = self.Fourier_filter_free_3d(conv3, threshold=0, scale=self.s1)
        ...
        conv2 = self.Fourier_filter_free_3d(conv2, threshold=0, scale=self.s1)
        ...
        conv13 = self.Fourier_filter_free_3d(conv1, threshold=0, scale=self.s1)
